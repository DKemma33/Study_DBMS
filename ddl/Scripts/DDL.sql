 ...
 * */
  ...
  create table tbl_shopping_category(
   id bigint unsigned auto_increment primary key,
   shopping_category _name varchar(255) not null
   );
  ...
  create table tbl_category(
   ...
   constraint fk_category_1_name foreign key(category1_id)
   references tbl_category1(id)
  );
   
   create table tbl_category3(
   id bigint unsigned auto_increment primary key,
   category_3_name varchar(255) not null,
   category2_id bigint unsigned,
   constraint fk_category_2_name foreign key(category2_id)
   references tbl_category2(id)
  );
  ...
  /*
   * 쇼핑        쇼핑2		        쇼핑3
    카테고리  카테고리/카테고리	카테고리/카테고리/카테고리
 */
  create table tbl_shopping_category(
  id bigint unsigned auto_increment primary key,
  shopping_category_name varchar(255)not null
  );
 
  create table tbl_ctegory_list(
  id bigint unsigned auto_increment primary key,
  category_list_name varchar(255)not null,
  shopping_category_id bigint unsigned,
  constraint fk_shopping_category_list foreign key(shopping_category_id)
  references tbl_category_list(id)
  );
...
/*============================================================*/
 creat 
  ...
  create table tbl_category_main(
   id bigint unsigned auto_increment primary key,
   category_main_name varchar(255) not null
   );
  ...
  create table tbl_sub_category(
   ...
   category_main_id bigint unsigned,
   constraint fk_category_main_name foreign key(category_main_id)
   references tbl_category_main(id)
  );
   
   create table tbl_sub2_category(
   id bigint unsigned auto_increment primary key,
   category_3_name varchar(255) not null,
   category2_id bigint unsigned,
   constraint fk_category_2_name foreign key(category2_id)
